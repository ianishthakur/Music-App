...
class Assets {
  ...
  static const tape = _imagePath + "tape.jpg";
  static const bokeh = _imagePath + "bokeh.jpg";
  static const radio = _imagePath + "radio.png";
  static const speaker = _imagePath + "loudspeaker.png";
